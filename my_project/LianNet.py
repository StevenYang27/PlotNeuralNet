...
arch = [
    ...
    # Full Connection
    to_FullConnection('fc1', s_filer=1, n_nueron=400, offset='(4, 0, 0)', to='(pool2-east)', caption='fc1'),
    to_connection('pool2', 'fc1'),
    to_connection_dot('fc1', 'pool2'),
    to_FullConnection('fc2', s_filer=1, n_nueron=120, offset='(1, 0, 0)', to='(fc1-east)', depth=30, caption='fc2'),
    to_connection('fc1', 'fc2'),
    to_FullConnection('fc3', s_filer=1, n_nueron=84, offset='(1, 0, 0)', to='(fc2-east)', depth=10, caption='fc3'),
